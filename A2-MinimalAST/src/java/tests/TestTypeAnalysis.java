...
public class TestTypeAnalysis extends AbstractParameterizedTest {
	/**
	 * Directory where test files live
	 */
	private static final String TEST_DIR = "testfiles/typeanalysis";

	/**
	 * Construct a new JastAdd test
	 * @param filename filename of test input file
	 */
	public TestTypeAnalysis(String filename) {
