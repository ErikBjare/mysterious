 ...
 */
abstract public class AbstractParameterizedCodeGenTest extends AbstractTestSuite {

	/**
	 * File extension for test input files. EDIT ME
	 */
	protected static final String IN_EXTENSION = ".c";
	/**
	 ...
	 * @param testFile
	 */
	public AbstractParameterizedCodeGenTest(String testDirectory, String testFile) {
		super(testDirectory);
